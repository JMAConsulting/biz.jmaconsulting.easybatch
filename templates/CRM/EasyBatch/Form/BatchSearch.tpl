<div id="batchclosetime"><div id="batchclosetimefrom" style="float:left">{$form.batch_date_from_hidden.html}</div> <div id="batchclosetimeto" style="overflow:hidden"><span id="totext">to</span>{$form.batch_date_to_hidden.html}</div></div>
{literal}
  <script type="text/javascript">
    CRM.$(function($) {
      ...
      $('#batchclosetimefrom .crm-form-date').change(function(){
        $('#batch_date_from').val($(this).val());
        $('#batch_date_from').change();
      });
      $('#batchclosetimeto .crm-form-date').change(function(){
